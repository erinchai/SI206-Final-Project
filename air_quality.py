...
def create_csv_file(file_name):
    data_header = ["average aqi"]
    data = [calc_wkly_avg_aqi(60,118)]
...
def calc_wkly_avg_aqi(city):
    ...
    return weekly_avgs
# calc_wkly_avg_aqi("New+York")
# calc_wkly_avg_aqi("Honolulu")
