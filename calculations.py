...
def main(): 
    ...
    calc_wkly_avg_temp(cur, con, "New+York")
    with open('temp.txt',"a") as f:
        f.write(f"Showing the average weekly temperatures for New York City from 1/1/23 - 2/28/23: {nyc_wkly_avgs}\n")

    calc_wkly_avg_temp(cur, con, "Honolulu")
    with open('temp.txt',"a") as f:
        f.write(f"Showing the average weekly temperatures for New York City from 1/1/23 - 2/28/23: {nyc_wkly_avgs}\n")
    
    calc_wkly_avg_aqi(cur, con, "New+York")
    with open('aqi.txt',"a") as f:
        f.write(f"Showing the average weekly aqi for New York City from 1/1/23 - 2/28/23: {nyc_wkly_avgs}\n")

    calc_wkly_avg_aqi(cur, con, "Honolulu")
    with open('aqi.txt',"a") as f:
        f.write(f"Showing the average weekly aqi for Honolulu from 1/1/23 - 2/28/23: {nyc_wkly_avgs}\n")

    calc_wkly_avg_humidity(cur,con,"New+York")
    with open('humidity.txt',"a") as f:
        f.write(f"Showing the average weekly humidity percentage for New York City from 1/1/23 - 2/28/23: {nyc_wkly_avgs}\n")
    
    calc_wkly_avg_humidity(cur,con,"Honolulu")
    with open('humidity.txt',"a") as f:
        f.write(f"Showing the average weekly humidity percentage for Honolulu from 1/1/23 - 2/28/23: {nyc_wkly_avgs}\n")
